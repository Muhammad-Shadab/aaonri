        ...
        context.theme.obtainStyledAttributes(
            ...
            try {
                color = getInteger(
                    ...
                    ContextCompat.getColor(context, R.color.blueBtnColor)
                )
                darkIcon = getBoolean(
    ...
    private fun buildBackgroundCircle(): ImageView {
        ...
        if (customBackgroundDrawable == -1) {
            val backgroundShapeDrawable = when (backgroundShape) {
                Shape.Circle -> ContextCompat.getDrawable(context, R.drawable.blue_circle_shape)
                Shape.RoundedRectangle -> ContextCompat.getDrawable(
                    context,
                    R.drawable.blue_rectangle_shape
                )
            }
