...
import com.aaonri.app.ui.dashboard.fragment.classified.fragment.AllClassifiedFragment
...
class ClassifiedPagerAdapter(fragment: Fragment) : FragmentStateAdapter(fragment) {
    ...
    override fun createFragment(position: Int): Fragment {
        return when (position) {
            ...
            else -> FavoriteClassifiedFragment()
        }
    }
}