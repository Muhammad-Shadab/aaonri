...
class ClassifiedViewModel @Inject constructor(private val classifiedRepository: ClassifiedRepository) :
    ...
    fun getFavoriteClassified(userEmail: String) = viewModelScope.launch {
        ...
        classifiedRepository.getFavoriteClassified(userEmail).onSuccess {
            favoriteClassifiedData.postValue(Resource.Success(it))
        }
            .onFailure {
                favoriteClassifiedData.postValue(Resource.Error(it.localizedMessage))
            }
    ...
    fun getClassifiedByUser(getClassifiedsByUserRequest: GetClassifiedByUserRequest) =
        viewModelScope.launch {
            ...
            classifiedRepository.getClassifiedByUser(getClassifiedsByUserRequest).onSuccess {
                classifiedByUserData.postValue(Resource.Success(it))
            }
                .onFailure {
                    classifiedByUserData.postValue(Resource.Error(it.localizedMessage))
                }
    ...
    fun getMyClassified(getClassifiedRequest: GetClassifiedByUserRequest) = viewModelScope.launch {
        ...
        classifiedRepository.getClassifiedByUser(getClassifiedRequest).onSuccess {
            myClassified.postValue((Resource.Success(it)))
        }
            .onFailure {
                myClassified.postValue((Resource.Error(it.localizedMessage)))
            }
    ...
    fun likeDislikeClassified(likeDislikeClassifiedRequest: LikeDislikeClassifiedRequest) =
        viewModelScope.launch {
            ...
            classifiedRepository.likeDislikeClassified(likeDislikeClassifiedRequest).onSuccess {
                likeDislikeClassifiedData.postValue(Resource.Success(it))
            }
                .onFailure {
                    likeDislikeClassifiedData.postValue(Resource.Error(it.localizedMessage))
                }
            /*val response =
    ...
    fun findByEmail(email: String) = viewModelScope.launch {
        ...
        classifiedRepository.getClassifiedSellerName(email).onSuccess {
            findByEmailData.postValue(Resource.Success(it))
        }
            .onFailure {
                findByEmailData.postValue(Resource.Error(it.localizedMessage))
            }
    ...
    fun getClassifiedSellerName(email: String) = viewModelScope.launch {
        ...
        classifiedRepository.getClassifiedSellerName(email).onSuccess {
            classifiedSellerNameData.postValue(Resource.Success(it))
        }
            .onFailure {
                classifiedSellerNameData.postValue(Resource.Error(it.localizedMessage))
            }
        /*val response = classifiedRepository.getClassifiedSellerName(email)
    ...
    fun getClassifiedLikeDislikeInfo(email: String, addId: Int, service: String) =
        viewModelScope.launch {
            ...
            classifiedRepository.getClassifiedLikeDislikeInfo(email, addId, service).onSuccess {
                classifiedLikeDislikeInfoData.postValue(Resource.Success(it))
            }
                .onFailure {
                    classifiedLikeDislikeInfoData.postValue(Resource.Error(it.localizedMessage))
                }
            /*val response =
